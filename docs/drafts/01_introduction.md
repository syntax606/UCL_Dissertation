...
Response tokens such as yeah, okay and right have long been problematic for accounts of meaning that must proceed from lexical content. Their propositional contribution is negligible, yet they are among the most frequent items in spontaneous dialogue, and the work they perform varies sharply across instances of what is orthographically a single word, varying from a neutral backchannel function to bitter sarcasm. Gardner (2001) characterises this class as deriving its interpretive force from phonetic form, prosodic shape and sequential placement rather than from lexical semantics. These properties are referred to throughout as delivery: how something is said, as distinct from which words are said. Gravano et al. (2012) demonstrate that the competing functions of affirmative cue words are distinguished in spontaneous speech by delivery. A warm yeah, a grudging yeah and a mocking yeah share a transcript and perform three distinct communicative acts, and the distinction is available to listeners, but not with complete agreement across all listeners. Rockwell (2000) found listeners unable to discriminate spontaneous sarcasm from non-sarcasm, though annotators in the present study recover the contrast from audio at 0.73 against a three-way chance level of 0.33, and from transcript alone at 0.65 [4.1]. In spite of some ambiguity, items of this kind are of methodological as well as descriptive interest, since they constitute naturally occurring minimal pairs in which lexical content is fixed and interpersonal force varies.
